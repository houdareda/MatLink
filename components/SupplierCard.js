    ...
    <div className="bg-white rounded-2xl border border-foreground/5 shadow-md hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 group flex flex-col h-full overflow-hidden">
      ...
      <div className="p-6 pb-4">
        <div className="flex justify-between items-start mb-6">
          <div className="w-16 h-16 bg-muted/30 rounded-2xl flex items-center justify-center border border-foreground/5 group-hover:bg-primary/5 transition-colors shrink-0">
        ...
        <h3 className="text-xl font-black text-foreground mb-3 text-right group-hover:text-primary transition-colors">
          {supplier.name}
        </h3>
        
        <p className="text-xs text-foreground/40 font-bold leading-relaxed text-right line-clamp-2 h-10">
          {supplier.description}
        </p>
      </div>

      {/* Stats/Quick Info */}
      <div className="px-6 py-4 bg-muted/20 border-y border-foreground/5 flex items-center justify-between">
